...
<div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                  <div class="col-sm-12">
                    이름 : ${sessionScope.userDTO.name}
                  </div>
                </div>
                <div class="form-group">
					<div class="col-sm-12">
					성별 : ${CodeUtil.getCodeName(sessionScope.userDTO.gender)}
                	</div>
                </div>
   
                <div class="form-group">
                <div class="col-sm-12">
					생년월일 : ${sessionScope.userDTO.birth}
                </div>               
                </div>
              </div>
...
<div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                	<div class="col-sm-12">
					이메일 : ${sessionScope.userDTO.email}
					</div>
                </div>
                <div class="form-group">
					<div class="col-sm-12">
                    	전화번호 : ${sessionScope.userDTO.phone}
                	</div>
                </div>
                <div class="form-group">
					<div class="col-sm-12">
					지역 및 주소 : ${sessionScope.userDTO.addr}
					</div>
                </div>
              </div>
