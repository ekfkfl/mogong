...
<form class="form-horizontal" method="post"
	action="${pageContext.request.contextPath}/studyUpdate?studyCode=${studyDTO.studyCode}"
	name="update">
						...
						<div class="form-group">
							<div class="col-sm-12">
								<input type="text" class="form-control" id="name" name="name"
									placeholder="스터디 제목을 입력하세요" value="${studyDTO.name}"> <br>
								<label>시작일 / 마감일</label>
			...
			<div
				...
				<div class="box box-info">
					...
					<input type="hidden" name="addr" /> <input type="text"
						...
						placeholder="주소를 입력하세요" value="${studyDTO.addr1}"> <input
						type="text" class="form-control" id="addr2" name="addr2"
						placeholder="상세 주소를 입력해주세요." value="${studyDTO.addr2}">
				</div>
				</div>
			</div>
		</div>
