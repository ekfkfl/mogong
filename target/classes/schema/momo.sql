...
CREATE TABLE MEMBER(
  ...
  JOIN_STATUS NUMBER DEFAULT 0, -- 가입상태
...
CREATE TABLE TASK(
  ...
  CONTENT VARCHAR2(300) NOT NULL, -- 태스크 내용
  PROGRESS_STATUS NUMBER DEFAULT 0, -- 진행상태
  START_DATE DATE NOT NULL, -- 시작일
  END_DATE DATE NOT NULL, -- 종료일
...
CREATE TABLE RECV_MESSAGE(
  ...
  CONFIRM NUMBER DEFAULT 0 -- 받은 쪽지 확인 유무
)
...
CREATE TABLE COMM_CODE(
  COMM_CODE VARCHAR2(6) PRIMARY KEY, -- 공통코드번호
